      ...
      {menuOpen && (
        <div className="md:hidden border-t border-border bg-card/95 backdrop-blur-xl px-6 py-4 space-y-2">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="block w-full text-left px-3 py-2 rounded-lg text-sm text-muted-foreground hover:text-foreground hover:bg-secondary transition-colors"
          >
            GitHub
          </a>
          <button
            ...
            className="w-full text-left px-3 py-2 rounded-lg text-sm font-medium text-primary hover:bg-secondary transition-colors"
          >
            {loggedIn ? "Sign out" : "Get Started"}
          </button>
        </div>
